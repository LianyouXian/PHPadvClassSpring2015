...
use Exception;
 final class Index {
    ...
    function runPage() {
        ...
        $_gameTypemodel = new GameTypeModel();
        $_gamemodel = new GameModel();
        
        //constructor for the DAO's getting the correct DB, logs, and models for each DAO
        $_gameTypeDAO = new GameTypeDAO($_pdo->getDB(), $_gameTypemodel, $_log);
        $_gameDAO = new GameDAO($_pdo->getDB(), $_gamemodel, $_log);
        
        
        $_gametypeService = new GameTypeService($_gameTypeDAO, $_validator, $_gameTypemodel );
        $_gameService = new GameService($_gameDAO, $_gametypeService, $_validator, $_gamemodel);
        ...
        ->addDIController('gametype', function()  use ($_gametypeService ){           
            return new \APP\controller\GameTypeController($_gametypeService);
        })
        ->addDIController('game', function()  use ($_gameService ){           
            return new \APP\controller\GameController($_gameService);
        })
