...
class GameTypeService implements IService {
    ...
    public function __construct( IDAO $GameTypeDAO, IService $validator,IModel $model  ) {
        $this->setDAO($GameTypeDAO);
    ...
    public function validate( IModel $model ) {
        $errors = array();
        if ( !$this->getValidator()->gameTypeIsValid($model->getGametype()) ) {
    ...
    public function getNewGameTypeModel() {
